...
<div class="bg-white dark:bg-neutral-900">
    <div
        ...
        <div>
            ...
            <dl class="mt-8 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-1 sm:gap-y-16 lg:gap-x-8">
                <ul class="flex flex-wrap text-center text-sm font-medium" data-tabs-toggle="#myTabContent" id="myTab"
                    role="tablist">
                    <li class="mr-2" role="presentation">
                        <button aria-controls="profile" aria-selected="false"
                            class="inline-block rounded-t-lg border-b-2 p-4" data-tabs-target="#profile"
                            id="profile-tab" role="tab" type="button">Description</button>
                    </li>
                    <li class="mr-2" role="presentation">
                        <button aria-controls="reviews" aria-selected="false"
                            class="inline-block rounded-t-lg border-b-2 p-4 hover:border-gray-300 hover:text-gray-600 dark:hover:text-gray-300"
                            data-tabs-target="#reviews" id="reviews-tab" role="tab" type="button">Reviews</button>
                    </li>
                    <li class="mr-2" role="presentation">
                        <button aria-controls="settings" aria-selected="false"
                            class="inline-block rounded-t-lg border-b-2 p-4 hover:border-gray-300 hover:text-gray-600 dark:hover:text-gray-300"
                            data-tabs-target="#settings" id="settings-tab" role="tab"
            ...
            <div id="myTabContent">
                ...
                <!--Reviews--->
                <div aria-labelledby="reviews-tab" class="hidden h-96 rounded-sm bg-gray-50 p-4 dark:bg-gray-800"
                    ...
                    <article>
                        <div class="mb-4 flex items-center space-x-4">
                            ...
                            <div class="font-medium dark:text-white">
                                <p>Jese Leos <time atetime="2014-08-16 19:00"
                        ...
                        <a class="mb-5 block text-sm font-medium text-blue-600 hover:underline dark:text-blue-500"
                            href="#">Read
                            more</a>
                        <aside>
                            ...
                            <div class="mt-3 flex items-center space-x-3 divide-x divide-gray-200 dark:divide-gray-600">
                                <a class="rounded-lg border border-gray-300 bg-white px-2 py-1.5 text-xs font-medium text-gray-900 hover:bg-gray-100 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:border-gray-600 dark:bg-gray-800 dark:text-white dark:hover:border-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-700"
                                    href="#">Helpful</a>
                                <a class="pl-4 text-sm font-medium text-blue-600 hover:underline dark:text-blue-500"
                                    href="#">Report
                                    abuse</a>
                            </div>
                        </aside>
                ...
                <!--Details--->
                <div aria-labelledby="settings-tab" class="hidden h-96 rounded-sm bg-gray-50 p-4 dark:bg-gray-800"
                    id="settings" role="tabpanel">
                    <p class="text-sm text-gray-500 dark:text-gray-400">This is some
                        placeholder content the <strong class="font-medium text-gray-800 dark:text-white">Details tab's
                            associated
            ...
            <div class="ml-auto flex pt-2">
                ...
                <form action="{{ route('reserve.create', ['house_id' => $house->id]) }}" method="POST">
                    @csrf
                ...
                <button
                    ...
                    <svg class="h-5 w-5" fill="white" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        viewBox="0 0 24 24">
                        <path
                        ...
                        <div class="mb-4 dark:border-gray-700">
                            <div class="house-img grid gap-1">
                                <div class="img-container">
                                    <img alt="" class="h-500px w-500px rounded-sm" id="imageBox"
