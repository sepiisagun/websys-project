		...
		<div class="lg:w-4/5 mx-auto flex flex-wrap">
			<div class="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
						...
						<li>
							<div class="flex items-center">
								...
								<a href="{{ route("house.index") }}"
									class="ml-1 text-sm font-medium text-gray-700 hover:text-teal-600 md:ml-2">Listings</a>
							</div>
						</li>
				...
				<div class="flex flex-row justify-between my-5">
					...
					<p
						class="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 font-normal text-base leading-4 text-gray-700 hover:underline hover:text-gray-800 dark:text-black duration-100 cursor-pointer">
						22 reviews</p>
				</div>
					...
					<ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="myTab"
						...
						<li class="mr-2" role="presentation">
							<button
								...
								aria-controls="settings" aria-selected="false">Details</button>
						</li>
					</ul>
				</div>
				...
				<div id="myTabContent">
					...
					<div class="hidden p-4 rounded-sm bg-gray-50 dark:bg-gray-800" id="profile" role="tabpanel"
						...
						<div class="flex border-t border-gray-300 py-2">
							...
							<span class="ml-auto text-gray-500 dark:text-gray-400">For {{ $item['capacity'] }}
								persons</span>
						</div>
					...
					<!--Reviews--->
					<div class="hidden p-4 rounded-sm bg-gray-50 dark:bg-gray-800" id="reviews" role="tabpanel"
						aria-labelledby="reviews-tab">
						<article>
							<div class="flex items-center mb-4 space-x-4">
								<img class="w-10 h-10 rounded-full" src="https://flowbite.com/docs/images/logo.svg"
									alt="">
							...
							<div class="flex items-center mb-1">
								...
								<h3 class="ml-2 text-sm font-semibold text-gray-900 dark:text-white">Thinking to buy
									another one!</h3>
							</div>
							...
							<p class="mb-2 font-light text-gray-500 dark:text-gray-400">This is my third Invicta Pro
							...
							<p class="mb-3 font-light text-gray-500 dark:text-gray-400">It is obviously not the same
					...
					<div class="hidden p-4 rounded-sm bg-gray-50 dark:bg-gray-800" id="settings" role="tabpanel"
						...
						<p class="text-sm text-gray-500 dark:text-gray-400">This is some placeholder content the <strong
								class="font-medium text-gray-800 dark:text-white">Details tab's associated
				...
				<div class="flex pt-8">
					...
					<button
						class="flex ml-auto text-white bg-gray-900 border-0 py-2 px-6 focus:outline-none hover:bg-gray-600 rounded">Reserve</button>
					<button
