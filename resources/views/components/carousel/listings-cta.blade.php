	...
	<div
		...
		<div>
			<h2 class="mt-5 text-center text-3xl font-bold tracking-tight text-neutral-900 sm:text-4xl">
				<span class="text-transparent bg-clip-text bg-gradient-to-r to-neutral-900 from-neutral-500 dark:bg-gradient-to-r dark:to-blue-500 dark:from-cyan-200">{{ config('constants.LISTINGS_CARD.TITLE') }}</span>
