<div class="bg-slate-50 dark:bg-neutral-900">
	<div
		...
		<div>
			<h2 class="mt-5 text-center text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
				<span class="text-transparent bg-clip-text bg-gradient-to-r to-neutral-900 from-neutral-500 dark:bg-gradient-to-r dark:to-blue-500 dark:from-cyan-200">{{ config('constants.TESTIMONIAL_CARD.TITLE') }} </span>
			</h2>
		...
		<dl class="mt-2 grid grid-cols-1 gap-x-6 gap-y-5 sm:grid-cols-2 sm:gap-y-4 lg:grid-cols-4 lg:gap-x-8">
