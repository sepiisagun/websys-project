    ...
    <div class="relative w-full h-full max-w-md md:h-auto">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <button type="button"
                ...
                data-modal-hide="registration-modal" onclick="closeModal()">
            ...
            <div class="px-6 py-6 lg:px-8">
                ...
                <form class="space-y-6" method="POST" action="{{ route('register') }}">
                    @csrf
                        ...
                        <button type="button" data-modal-target="authentication-modal" data-modal-toggle="authentication-modal" data-modal-hide="registration-modal"
...
<script>
    var $targetEl = document.getElementById('registration-modal');
    var $targetEl2 = document.getElementById('authentication-modal');
        ...
        var modal2 = new Modal($targetEl2, options);
