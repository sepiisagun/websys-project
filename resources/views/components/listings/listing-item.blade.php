...
<div class="group relative">
	<div class="group relative h-100 max-w-sm cursor-pointer items-center justify-center overflow-hidden rounded-t-lg shadow transition-shadow hover:shadow-xl hover:shadow-black/30"
	>
		<img alt="" class="rounded-t-lg transition-transform duration-500 group-hover:scale-90" src="/img/{{ $item['image_path'] }}" />
		<div class="from-none absolute inset-0 rounded-t-lg bg-gradient-to-b via-transparent to-black group-hover:from-black/60 group-hover:via-black/70 group-hover:to-black/80">
