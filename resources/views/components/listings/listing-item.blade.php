    ...
    <div
        ...
        <div
            ...
            <div
                ...
                <a class="btn-sky dark:btn-white inline-flex items-center rounded-lg px-3 py-2 text-center text-sm font-medium"
        ...
        <div class="p-5">
            <a href="{{ route('house.show', $house->id) }}">
                <h6 class="mb-5 block align-top text-xs font-medium tracking-tight text-sky-600">
                    {{ $house->address }}
                </h6>
                <h5 class="text-1xl block align-middle font-bold tracking-tight text-neutral-900 dark:text-white">
                    {{ $house->name }}
                </h5>
            </a>
            <p class="text-md inline-block align-bottom font-normal text-neutral-700 dark:text-white">
