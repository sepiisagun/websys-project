			...
			>
				<div class="mb-6 grid gap-4 sm:grid-cols-1 sm:gap-6">
					...
					<div class="sm:col-span-2">
						...
						<textarea
						 class="focus:ring-primary-500 focus:border-primary-500 dark:focus:ring-primary-500 dark:focus:border-primary-500 min-h-1/2 block w-full rounded-sm border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400"
						 id="description"
